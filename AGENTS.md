...
+ All module apis can be referenced by other module should be placed in `lox` namespace，for module local apis, place them in `lox::<module>` namespace, for file local apis, place them in an anonymous namespace.
